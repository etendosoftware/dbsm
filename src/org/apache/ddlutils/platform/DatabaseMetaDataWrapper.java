...
public class DatabaseMetaDataWrapper {
  ...
  /**
   * Convenience method to return the table meta data using the configured catalog, schema pattern
   * and table types.
   * 
   ...
   * @see DatabaseMetaData#getTables(java.lang.String, java.lang.String, java.lang.String,
   *      java.lang.String[])
   */
  ...
  /**
   * Convenience method to return the column meta data using the configured catalog and schema
   * pattern.
   * 
   * @param tableNamePattern
   *          The pattern identifying for which tables to return info
   ...
   * @throws SQLException
   *           If an error occurred retrieving the meta data
   * @see DatabaseMetaData#getColumns(java.lang.String, java.lang.String, java.lang.String,
   *      java.lang.String)
   */
  ...
  /**
   * Convenience method to return the primary key meta data using the configured catalog and schema
   * pattern.
   * 
   * @param tableNamePattern
   *          The pattern identifying for which tables to return info
  ...
  /**
   * Convenience method to return the foreign key meta data using the configured catalog and schema
   * pattern.
   * 
   * @param tableNamePattern
   *          The pattern identifying for which tables to return info
  ...
  /**
   * Convenience method to return the index meta data using the configured catalog and schema
   * pattern.
   * 
   * @param tableNamePattern
   *          The pattern identifying for which tables to return info
   ...
   * @throws SQLException
   *           If an error occurred retrieving the meta data
   * @see DatabaseMetaData#getIndexInfo(java.lang.String, java.lang.String, java.lang.String,
   *      boolean, boolean)
   */
  public ResultSet getIndices(String tableNamePattern, boolean unique, boolean approximate)
      throws SQLException {
    return getMetaData().getIndexInfo(getCatalog(), getSchemaPattern(), tableNamePattern, unique,
        approximate);
  }
}
