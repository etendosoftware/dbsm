...
public class PostgrePLSQLTriggerStandarization extends
    ...
    public PostgrePLSQLTriggerStandarization(Database database, int numTrigger) {
        ...
        /*
         * final Database database2=database; final int
         * numTrigger2=numTrigger;http://www.marca.com/ append(new Translation()
         * { Trigger trigger=database2.getTrigger(numTrigger2); public String
         * exec(String s) { int i = s.lastIndexOf("END "); return i >= 0 ?
         * s.substring(0, i + 4)+trigger.getName() : s; } });
         */
