    ...
    try {
      while ((inputStr = br.readLine()) != null) {
        ...
        if (matcher1.find()) {
          ...
          bw.write(matcher37.group(1) + "RAISE EXCEPTION '%','RBack'; --OBTG:tosavepoint"
              + matcher37.group(2));
          ...
          bw.write(matcher5.group(1) + "RAISE NOTICE '%'," + matcher5_1.replaceAll("'")
          ...
          bw.write(matcher5a.group(1) + "RAISE NOTICE '%'," + matcher5a1.replaceAll("'")
          ...
          bw.write(matcher11.group(1) + "RAISE EXCEPTION '%'," + matcher11a.replaceAll("'")
              + (matcher11.group(8) != null ? matcher11.group(8) : "") + ";" + " --OBTG:" + code
              + "--");
          ...
          bw.write(matcher12.group(1) + "RAISE EXCEPTION '%'," + matcher12a.replaceAll("'")
              + (matcher12.group(8) != null ? matcher12.group(8) : "") + ";" + " --OBTG:" + code
              + "--");

        } else if (matcher6.find()) {
          bw.write(matcher6.group(1) + "DECLARE " + matcher6.group(3) + " CURSOR "
          ...
          bw.write(matcher23a.group(1) + "RAISE EXCEPTION '%', SQLERRM;");
          ...
          bw.write(matcher25.group(1) + matcher25.group(2) + "[" + matcher25.group(4) + "]"
              + matcher25.group(6));
          ...
          bw.write(matcher36.group(1) + matcher36.group(2) + matcher36.group(4) + "('"
              + matcher36.group(3) + "')" + matcher36.group(5));
        } else {
          bw.write(inputStr);
        }
        bw.write("\n");
