...
/**
 * Conatains information about the database platform such as supported features
...
public class PlatformInfo {
    ...
    /**
     * Determines whether the checks are embedded in the create table clause or
     * as seperate statements. Per default, checks are external.
     * 
    ...
    /**
     * Specifies whether checks are embedded in the create table clause or as
     * seperate alter table statements.
     * 
     ...
     *            auto-incrementing
     */
    public void setNonPKIdentityColumnsSupported(
            boolean supportingNonPKIdentityColumns) {
     ...
     *            non-unique
     */
    public void setSystemForeignKeyIndicesAlwaysNonUnique(
            boolean alwaysNonUnique) {
     ...
     *            non-identity required columns
     */
    public void setSyntheticDefaultValueForRequiredReturned(
     ...
     */
    public void setIdentityStatusReadingSupported(
            boolean canReadAutoIncrementStatus) {
    ...
    public int getTargetJdbcType(int typeCode) {
        Integer targetJdbcType = (Integer) _targetJdbcTypes.get(new Integer(
                typeCode));
    ...
    public void addNativeTypeMapping(int jdbcTypeCode, String nativeType,
        ...
        _targetJdbcTypes.put(new Integer(jdbcTypeCode), new Integer(
                targetJdbcTypeCode));
    }
    ...
    public void addNativeTypeMapping(String jdbcTypeName, String nativeType,
        ...
        try {
            ...
            // ignore -> won't be defined
            _log.warn(
                    "Cannot add native type mapping for undefined jdbc type "
                            + jdbcTypeName + ", target jdbc type "
                            + targetJdbcTypeName, ex);
        }
    }
    ...
    public void setDefaultSize(int jdbcTypeCode, int defaultSize) {
        _typesDefaultSizes.put(new Integer(jdbcTypeCode), new Integer(
                defaultSize));
    }
