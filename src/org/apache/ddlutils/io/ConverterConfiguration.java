...
/**
 * Contains the configuration for converters, which convert between the Java
 * data types corresponding to SQL data, and string representations.
 * 
...
public class ConverterConfiguration {
    ...
    public ConverterConfiguration() {
        ...
        if (Jdbc3Utils.supportsJava14JdbcTypes()) {
            registerConverter(Jdbc3Utils.determineBooleanTypeCode(),
                    numberConverter);
        }
    }
     ...
     *            The converter
     */
    public void registerConverter(String tableName, String columnName,
    ...
    public SqlTypeConverter getRegisteredConverter(Table table, Column column) {
        ...
        if (result == null) {
            result = (SqlTypeConverter) _convertersPerType.get(new Integer(
                    column.getTypeCode()));
        }
        return result;
    }
