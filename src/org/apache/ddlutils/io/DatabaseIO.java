...
public class DatabaseIO {
  /**
   * The name of the XML attribute use to denote that teh content of a data XML element uses Base64
   * encoding.
   */
  ...
  /**
   * Reads the database model contained in the specified file but does not initialize the database
   * 
   * @param file
   *          The model file
   * @return The database model
  ...
  /**
   * Writes the database model to the given output stream. Note that this method does not flush the
   * stream.
   * 
   * @param model
   *          The database model
  ...
  /**
   * Writes the database model to the given output writer. Note that this method does not flush the
   * writer.
   * 
   * @param model
   *          The database model
