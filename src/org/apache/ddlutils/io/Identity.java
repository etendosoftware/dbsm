...
/**
 * Stores the identity of an database object as defined by its primary keys. Is used by
 * {@link org.apache.ddlutils.io.DataToDatabaseSink} class for inserting objects in the correct
 * order.
 * 
...
public class Identity {
  ...
  /**
   * Returns the name of the foreign key whose referenced object this identity represents. This name
   * is <code>null</code> if the identity is not for a foreign key, or if the foreign key was
   * unnamed.
   * 
