 ...
 * {@link org.apache.ddlutils.io.DataToDatabaseSink} to insert the objects in the correct order
 * according to their foreign keys.
 * 
...
public class WaitingObject {
  ...
  /**
   * Determines whether there are any identities of waited-for objects registered with this waiting
   * object.
   * 
