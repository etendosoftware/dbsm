...
/**
 * Converts between {@link java.sql.Date} and {@link java.lang.String} using the
 * standard representation "yyyy", or "yyyy-mm", or "yyyy-mm-dd".
 * 
...
public class DateConverter implements SqlTypeConverter {
    ...
    public Object convertFromString(String textRep, int sqlTypeCode)
        ...
        if (sqlTypeCode != Types.DATE) {
            ...
            // we're not using {@link java.sql.Date#valueOf(String)} as this
