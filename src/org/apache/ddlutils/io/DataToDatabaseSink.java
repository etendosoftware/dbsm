...
//        _mergedTables.clear();
    ...
    private void insertBeanIntoDatabase(Table table, DynaBean bean) throws DataSinkException
    {
        ...
        else
        {
            ...
            upsertSingleBeanIntoDatabase(table, bean); // this method ignored FK because it must be disabled originally
        }
    }
    ...
    /**
     * Directly inserts the given bean into the database with delete old data from table.
     *  before you are recommended disable all trigger and FK constraint
     * @param table The table of the bean
     * @param bean  The bean
     */
