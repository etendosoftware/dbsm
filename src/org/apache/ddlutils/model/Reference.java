...
public class Reference implements Cloneable, Serializable {
  ...
  /**
   * Sets the sequence value within the owning key. Please note that you should not change the value
   * once the reference has been added to a key.
   * 
   * @param sequenceValue
   *          The sequence value
   */
  ...
  /**
   * Sets the name of the local column. Note that you should not use this method when manipulating
   * the model manually. Rather use the {@link #setLocalColumn(Column)} method.
   * 
  ...
  /**
   * Sets the name of the remote column. Note that you should not use this method when manipulating
   * the model manually. Rather use the {@link #setForeignColumn(Column)} method.
   * 
