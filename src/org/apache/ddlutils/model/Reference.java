...
public class Reference implements Cloneable, Serializable {
    ...
    public void setForeignColumn(Column foreignColumn) {
        ...
        _foreignColumnName = (foreignColumn == null ? null : foreignColumn
                .getName());
    }
    ...
    public void setLocalColumnName(String localColumnName) {
        if ((_localColumn != null)
                && !_localColumn.getName().equals(localColumnName)) {
            _localColumn = null;
        }
    ...
    public void setForeignColumnName(String foreignColumnName) {
        if ((_foreignColumn != null)
                && !_foreignColumn.getName().equals(foreignColumnName)) {
            _foreignColumn = null;
        }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Reference) {
            ...
            return new EqualsBuilder().append(_localColumnName,
                    other._localColumnName).append(_foreignColumnName,
                    other._foreignColumnName).isEquals();
        } else {
            return false;
        }
    }
    ...
    public boolean equalsIgnoreCase(Reference otherRef) {
        return (otherRef != null)
                ...
                && _foreignColumnName
                        .equalsIgnoreCase(otherRef._foreignColumnName);
    }
     ...
     */
    public int hashCode() {
        return new HashCodeBuilder(17, 37).append(_localColumnName).append(
                _foreignColumnName).toHashCode();
    }
