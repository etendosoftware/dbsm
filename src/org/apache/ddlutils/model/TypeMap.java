...
public abstract class TypeMap {
    ...
    /**
     * The string representation of the {@link java.sql.Types#NVARCHAR}
     * constant.
     */
    ...
    static {
        ...
        registerJdbcType(ExtTypes.NVARCHAR, NVARCHAR,
                JdbcTypeCategoryEnum.TEXTUAL);
    ...
    public static boolean isNumericType(int jdbcTypeCode) {
        Set typesInCategory = (Set) _typesPerCategory
                .get(JdbcTypeCategoryEnum.NUMERIC);
    ...
    public static boolean isDateTimeType(int jdbcTypeCode) {
        Set typesInCategory = (Set) _typesPerCategory
                .get(JdbcTypeCategoryEnum.DATETIME);
    ...
    public static boolean isTextType(int jdbcTypeCode) {
        Set typesInCategory = (Set) _typesPerCategory
                .get(JdbcTypeCategoryEnum.TEXTUAL);
    ...
    public static boolean isBinaryType(int jdbcTypeCode) {
        Set typesInCategory = (Set) _typesPerCategory
                .get(JdbcTypeCategoryEnum.BINARY);
    ...
    public static boolean isSpecialType(int jdbcTypeCode) {
        Set typesInCategory = (Set) _typesPerCategory
                .get(JdbcTypeCategoryEnum.SPECIAL);
