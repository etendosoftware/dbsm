...
/**
 * A class that maps SQL type names to their JDBC type ID found in {@link java.sql.Types} and vice
 * versa.
 * 
...
public abstract class TypeMap {
  ...
  static {
    ...
    registerJdbcType(ExtTypes.NCHAR, NCHAR, JdbcTypeCategoryEnum.TEXTUAL);
  ...
  /**
   * Returns the JDBC type code (one of the {@link java.sql.Types} constants) that corresponds to
   * the given JDBC type name.
   * 
   * @param typeName
  ...
  /**
   * Returns the JDBC type name that corresponds to the given type code (one of the
   * {@link java.sql.Types} constants).
   * 
   * @param typeCode
   *          The type code
   * @return The JDBC type name (one of the constants in this class) or <code>null</code> if the
   *         type is unknown
   */
  public static String getJdbcTypeName(int typeCode) {
    return (String) _typeCodeToTypeName.get(Integer.valueOf(typeCode));
  }
  ...
  /**
   * Determines whether the given jdbc type (one of the {@link java.sql.Types} constants) is a
   * numeric type.
   * 
   * @param jdbcTypeCode
   *          The type code
  ...
  public static boolean isNumericType(int jdbcTypeCode) {
    ...
    return typesInCategory == null ? false
        : typesInCategory.contains(Integer.valueOf(jdbcTypeCode));
  }
  ...
  /**
   * Determines whether the given jdbc type (one of the {@link java.sql.Types} constants) is a text
   * type.
   * 
   * @param jdbcTypeCode
   *          The type code
  ...
  /**
   * Determines whether the given sql type (one of the {@link java.sql.Types} constants) is a
   * special type.
   * 
   * @param jdbcTypeCode
   *          The type code
