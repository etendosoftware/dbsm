...
public class DatabaseTestHelper extends Assert {
  ...
  /**
   * Asserts that the data in the tables described by the given model is the same in the database
   * accessed by the second platform as is in the database accessed by the first platform. Note that
   * it is not tested whether the second database has more data.<br/>
