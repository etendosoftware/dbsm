 ...
 * type B which is a subtype of A, and there is only a callback for type A, then
 * this one will be invoked. If there is however also a callback for type B,
...
public class CallbackClosure implements Closure {
     ...
     *            The parameter types. This array has to contain one
     *            <code>null</code> for the type of the object for which the
     *            callback is invoked. <code>null</code> or an empty array is
     *            regarded to be the same as an array containing a single
     *            <code>null</code>
     * @param parameters
     *            The actual arguments. The value at the placeholder position
     *            will be ignored. Can be <code>null</code> if no parameter
     *            types where given
     */
    public CallbackClosure(Object callee, String callbackName,
        ...
        if ((parameterTypes == null) || (parameterTypes.length == 0)) {
                ...
                if (parameterTypes[idx] == null) {
                    if (_callbackTypePos >= 0) {
                        throw new IllegalArgumentException(
                                "The parameter types may contain null only once");
                    }
            ...
            if (_callbackTypePos < 0) {
                throw new IllegalArgumentException(
                        "The parameter types need to a null placeholder");
            }
        }
    ...
    private boolean typesMatch(Class[] methodParamTypes) {
        if ((methodParamTypes == null)
                || (_parameterTypes.length != methodParamTypes.length)) {
            return false;
        }
