...
public class WriteSchemaToDatabaseCommand extends DatabaseCommandWithCreationParameters {
  ...
  /**
   * Determines whether to drop tables and the associated constraints before re-creating them (this
   * implies <code>alterDatabase</code> is <code>false</code>).
   * 
  ...
  /**
   * Specifies whether tables, external constraints, etc. can be dropped if necessary. Note that
   * this is only relevant when <code>alterDatabase</code> is <code>false</code>.
   * 
   * @param doDrops
