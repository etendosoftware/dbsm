...
/**
 * Task for getting structural info and data from a live database. Eg. it has
 * sub tasks for writing the schema of the live database or the data currently
 * in it to an XML file, for creating the DTDs for these data files, and for
 * generating SQL to creating a schema in the database to a file. <br/>
 * Example:<br/>
 * 
 * <pre>
 ...
 * </pre>
 * 
 * This reads the schema and data from the database and writes them to XML
 * files.
 * 
...
public class DatabaseToDdlTask extends DatabaseTaskBase {
    ...
    /**
     * Specifies the table types to be processed. More precisely, all tables
     * that are of a type not in this list, will be ignored by the task and its
     * sub tasks. For details and typical table types see <a href="http://java.sun.com/j2se/1.4.2/docs/api/java/sql/DatabaseMetaData.html#getTables(java.lang.String,%20java.lang.String,%20java.lang.String,%20java.lang.String[])"
     * >java.sql.DatabaseMetaData#getTables</a>.
     * 
     * @param tableTypes
     *            The table types as a comma-separated list
     * @ant.not-required By default, only tables of type <code>TABLE</code> are
     *                   used by the task.
     */
    ...
    /**
     * Specifies the name of the model that is read from the database. This is
     * mostly useful for the the <code>writeSchemaToFile</code> sub-task as it
     * ensures that the generated XML defines a valid model.
     * 
     * @param modelName
     *            The model name. Use <code>null</code> or an empty string for
     *            the default name
     * @ant.not-required By default, DldUtils uses the schema name returned from
     *                   the database or <code>"default"</code> if no schema
     *                   name was returned by the database.
     */
