...
/**
 * Specifies a parameter for the creation of the database. These are usually platform specific. A
 * parameter consists of a name-value pair and an optional list of platforms for which the parameter
 * shall be used.
 * 
...
public class Parameter {
  ...
  /**
   * Specifies the name of the parameter. See the database support documentation for details on the
   * parameters supported by the individual platforms.
   * 
   * @param name
   *          The name
   * @ant.required
