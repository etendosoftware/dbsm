...
public abstract class Command {
  ...
  /**
   * Determines whether the command execution will be stopped upon an error. Default value is
   * <code>true</code>.
   * 
   ...
   * 
   * @param failOnError
   *          <code>true</code> if the execution shall stop in case of an error
  ...
  /**
   * Handles the given exception according to the fail-on-error setting by either re-throwing it
   * (wrapped in a build exception) or only logging it.
   * 
   * @param ex
   *          The exception
   * @param msg
   *          The message to use unless this the exception is rethrown and it is already a build
   *          exception
   */
  ...
  /**
   * Specifies whether this command requires a model, i.e. whether the second argument in
   * {@link #execute(DatabaseTaskBase, Database)} cannot be <code>null</code>.
   * 
