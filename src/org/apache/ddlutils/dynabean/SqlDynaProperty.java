...
/**
 * A DynaProperty which maps to a persistent Column in a database. The Column
 * describes additional relational metadata for the property such as whether the
