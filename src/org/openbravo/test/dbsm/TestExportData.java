...
public class TestExportData extends TestCase {
  public void testConfig() {
    ...
    ecs.setOutput(new File(
        "/home/openbravo/workspaceModularity/openbravo/src-db/database/sourcedata/"));
    ...
    ecs
        .setPropertiesFile("/home/openbravo/workspaceModularity/openbravo/config/Openbravo.properties");
    /*
     * driver="${bbdd.driver}" url="${bbdd.owner.url}" user="${bbdd.user}"
     * filter="com.openbravo.db.OpenbravoMetadataFilter" password="${bbdd.password}"
     * excludeobjects="com.openbravo.db.OpenbravoExcludeFilter" moduledir="${base.modules}"
     * model="model" coreData="${base.db}/sourcedata" verbosity="${bbdd.verbosity}"
