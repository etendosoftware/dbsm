    ...
    public void doExecute() {
        ...
        for (int i = 0; i < dataFiles.size(); i++) {
            ...
            try {
                ...
                final String tablename = dataFiles.get(i).getName().substring(
                        0, dataFiles.get(i).getName().length() - 4);
        ...
        for (int i = 0; i < util.getModuleCount(); i++) {
            getLog().info(
                    "Creating submodel for module: " + util.getModule(i).name);
            Database dbI = null;
            try {
        ...
        getLog()
                .info("Changes that couldn't be exported to the config script:");
        getLog()
                .info("*******************************************************");
